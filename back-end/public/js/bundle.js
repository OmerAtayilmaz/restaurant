...
var showAlert = function showAlert(icon, title, text) {
  Swal.fire({
    icon: icon,
    title: title,
    text: text
...
var createBooking = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var name, phone, guests, date, time, email, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            name = _ref.name, phone = _ref.phone, guests = _ref.guests, date = _ref.date, time = _ref.time, email = _ref.email;
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _message.showAlert)("success", "Success", "Booking created successfully!");
            }
          ...
          case 8:
            ...
            (0, _message.showAlert)("error", "HATA", _context.t0.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./message":"message.js"}],"login.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.userLogin = exports.logout = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _message.showAlert)("success", "Success", "Logged in successfully");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _message.showAlert)("error", "Error logging out! Try again.");
...
},{"axios":"../../node_modules/axios/index.js","./message":"message.js"}],"signup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.userSignup = exports.logout = void 0;
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            name = _ref.name, email = _ref.email, password = _ref.password, passwordConfirm = _ref.passwordConfirm;
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: "POST",
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _message.showAlert)("success", "Registered", "Congratulations, your account has been successfully created.👋 ");
              window.setTimeout(function () {
                location.assign("/");
              }, 500);
            }
...
exports.logout = logout;
},{"axios":"../../node_modules/axios/index.js","./message":"message.js"}],"profile.js":[function(require,module,exports) {
...
var list = document.querySelector('.list-group-flush');
if (list) document.querySelector('.list-group-flush').addEventListener('click', function (e) {
  if (e.target.classList.contains('profile-list-item')) {
    e.target.classList.add('active');

    _toConsumableArray(e.target.parentElement.children).forEach(function (items) {
      if (items != e.target) {
...
if (bookingBtn) bookingBtn.addEventListener("click", function (e) {
  ...
  var bookingGuests = document.getElementById("BookingGuests").value;
