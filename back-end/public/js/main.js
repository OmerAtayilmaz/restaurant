...
import { userLogin, logout } from "./login";
...
if(bookingBtn)
  bookingBtn.addEventListener("click",(e)=>{
    ...
    const bookingData={name: bookingName, email: bookingEmail, phone: bookingPhone,guests:bookingGuests,time:bookingTime,date:bookingDate};
